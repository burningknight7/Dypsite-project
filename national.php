...
<body>
<center><h3>National Conferences</h3></center>
	<button class="btn btn-primary" data-toggle="modal" data-target="#nc_Conferences">Add More Details +</button><br>
	<?php
	include 'connect.php';
	@session_start();
	$id=$_SESSION['id'];
	$national="SELECT * FROM national WHERE uniqu='$id'";
	...
	";
	 $ndata=mysqli_query($con,$national);
	 $i=0;
	 while($row=mysqli_fetch_array($ndata))
	 {
	 	...
	 	echo "<tr><td>$i )</td><td>$n</td><td>$l</td><td>$t</td><td>$a</td><td>$p</td><td>$m</td><td><button type='button' class='btn' onclick='del_conf(\"".'national'."\",\"".$row['row_id']."\")'>Delete</button></td><td><button type='button' class='btn' data-toggle='modal' data-target='#u_conf' onclick='update_conf(\"".'national'."\",\"".$n."\",\"".$l."\",\"".$t."\",\"".$a."\",\"".$p."\",\"".$m."\",\"".$row['row_id']."\")'>Edit</button></td></tr>";
...
<div class="modal fade" id="nc_Conferences" role="dialog" style="">
	    <div class="modal-dialog modal-lg">
	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-footer">
	         <button type="button" id="AddNC" class="col-md-offset-4 col-md-4 btn btn-success btn-default" style="background-color: #b50f20" onclick="add_conf('national')">Add </button>
