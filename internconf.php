...
<body>
<center><h3>International Conferences</h3></center>
	<button class="btn btn-primary" data-toggle="modal" data-target="#ic_Conferences">Add new details + </button>
	<?php
	include 'connect.php';
	@session_start();
	$id=$_SESSION['id'];
	$international_conf="SELECT * FROM intconf WHERE uniqu='$id'";
	$ndata=mysqli_query($con,$international_conf);
	echo '<table class="table table-responsive">';
	echo "
	<tr><th>conf no</th><th>Conf Name</th><th>Conf.Location</th><th>paper title</th><th>Author details</th><th>proceeding no</th><th>month & year</th><th></th><th></th></tr>
	";
	 ...
	 while($row=mysqli_fetch_array($ndata))
	 {
	 	...
	 	echo "<tr><td>$i )</td><td>$n</td><td>$l</td><td>$t</td><td>$a</td><td>$p</td><td>$m</td><td><button class='btn' onclick='del_conf(\"".'intconf'."\",\"".$row['row_id']."\")'>Delete</button></td><td><button class='btn' data-toggle='modal' data-target='#u_conf' onclick='update_conf(\"".'international_conf'."\",\"".$n."\",\"".$l."\",\"".$t."\",\"".$a."\",\"".$p."\",\"".$m."\",\"".$row['row_id']."\")'>Edit</button></td></tr>";
	...
	<div class="modal fade" id="ic_Conferences" role="dialog" style="">
	    <div class="modal-dialog modal-lg">
	      ...
	      <div class="modal-content">
	        ...
	        <!--  <button type="button" id="AddNC" class="col-md-offset-4 col-md-4 btn btn-success btn-default" style="background-color: #b50f20" onclick="add_conf('national')">Add National conference </button> -->
	          <button type="button" id="AddIC" class="col-md-offset-4 col-md-4 btn btn-primary btn-default" onclick="add_conf('international_conf')"> Add </button>
	         <!-- <button type="button" id="AddIJ" class=" col-md-3 btn btn-success btn-default" onclick="add_conf('international_journal')"> Add international journal </button>  -->
	        </div>
	      </div>
